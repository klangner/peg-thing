...
(defn triangular?
  "Check if given number is triangular one e.g 1 3 6 10 ..."
  [n]
...
(defn place-peg
  "Put a peg on the board at the given position"
  [board pos]
  (assoc-in board [pos :pegged] true))

(defn move-peg "Take peg out of p1 and put it on p2"
  [board p1 p2]
...
(defn can-move?
  "Do any pegged positions have valid moves?"
  [board]
...
(defn letter->pos
  "converts letter string into corresponding position number"
  [letter]
...
(defn characters-as-strings
  "Convert string into collection of letters"
  [string]
...
(defn user-entered-valid-move
  [board]
  (if (can-move? board)
    (prompt-move board) (game-over board)))
